            ...
            <div class="mb-3">
              ...
              <div class="mb-3 px-3">
                <input
                  ...
                  title="Ingrese el numero de DUI"
                  required
                  autocomplete="off"
                />
              </div>
              <div class="mb-3 px-3">
                <input
                  ...
                  title="Ingrese el numero de telefono"
                  required
                  autocomplete="off"
                />
              </div>
              ...
              <div class="mb-3 px-3">
                <input
                  ...
                  autocomplete="off"
                  title="Favor ingrese su direccion"
                />
              </div>
              <div class="mb-3 px-3">
                <input
                  ...
                  placeholder="Usuario"
                  autocomplete="off"
                  title="Favor ingrese su usuario"
                />
              </div>
              <div class="mb-3 px-3">
                <input
