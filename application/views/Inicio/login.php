      ...
      <div class="card-body">
        <form action="" method="POST">
          <div class="mb-3">
            ...
            <div class="mb-3 px-3">
              <input type="text" name="usuario" id="usuario" class="form-control" required placeholder="Usuario" title="Ingrese su usuario" />
            </div>
            <div class="mb-3 px-3">
              <input name="password" id="password" type="password" class="form-control" placeholder="Ingrese su contraseña" required />
            </div>
