        ...
        <div>
          <section class="admin-card rounded center-all cursor-pointer mb-4">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <a href="<?= base_url(); ?>index.php/Productos/index"><span class="global-red-color fw-bold ms-2">Agregar productos</span></a>
            </div>
          </section>
        </div>
        <div>
          <section class="admin-card rounded center-all cursor-pointer mb-4">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <a href="<?= base_url(); ?>index.php/Proveedores/index"><span class="global-red-color fw-bold ms-2">Agregar proveedor</span></a>
            </div>
          </section>
        </div>
      </div>
