...
<script type="text/javascript">
    ...
    $('#mydata').dataTable({
        ...
        $.ajax({
            ...
            data : {nombre:nombre,descripcion:descripcion,precio:precio,stock:stock, sucursal:sucursal, marca:marca, categoria:categoria, proveedor:proveedor},
        ...
        $.ajax({
            ...
            data : {id_edit:id_edit,edit_nombre:edit_nombre,edit_descripcion:edit_descripcion,edit_precio:edit_precio,edit_stock:edit_stock,edit_sucursal:edit_sucursal,edit_marca:edit_marca,edit_categoria:edit_categoria,edit_proveedor:edit_proveedor},
            success: function(data){
                if(data == null){
                    document.getElementById('validacion_edit').innerHTML = '';
